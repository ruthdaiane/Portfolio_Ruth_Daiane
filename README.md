<h1>Portfólio para documentar o processo de aprendizado da disciplina de Programação Web.</h1>
...
Link para acesso ao projeto:
<a href="https://script.google.com/macros/u/1/s/AKfycbxkrWu6E2L-E3XsdnbJtIo51orr4kb-dn9GsV0soKYDY1hoJaTJqXBbS0bAluP2RbM/exec">MerendaEscolar</a>Portfólio para documentar o processo de aprendizado da disciplina de Programação Web.
...
<h1>Projeto: Lista de Exercicio I</h1>

Arquivo(s):
<ul>
	<li>ListaExercicio</li>
</ul>

Descrição: Página Web para mostrar um formulário HTML com a distancia, o consumo e o preço da gasolina que Joana fez na viajem. 
...
Erro Exception: No HTML file named ana was found. doGet @ Código.gs:2
